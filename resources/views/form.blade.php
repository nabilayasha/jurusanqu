        ...
        <div class="container">
            <div class="d-flex justify-content-center align-items-center flex-column content-hero">
                <div class="card p-4 pt-5 p-relative" style="z-index: 2">
                    ...
                    <form class="mx-auto needs-validation" style="width: 100%; max-width: 600px" method="post" action="store-biodata" novalidate>
                        @method('post')
                        @csrf
                        <div class="mb-3">
                            <label for="name" class="form-label">Nama Lengkap</label>
                            <input type="text" id="name" name="nama" class="form-control" placeholder="Nama lengkap Anda"
                                required />
                            <div class="invalid-feedback">Mohon isi nama lengkap</div>
                        </div>
                        <div class="mb-3">
                            <label for="school" class="form-label">Asal Sekolah</label>
                            <input type="text" id="school" name="sekolah" class="form-control" placeholder="Asal sekolah Anda"
                                required />
                            <div class="invalid-feedback">Mohon isi asal sekolah</div>
                        </div>
                        <div class="mb-5">
                            <label for="class" class="form-label">Kelas</label>
                            <select id="class" name="id_kelas" class="form-select" required aria-placeholder="Pilih Kelas">
