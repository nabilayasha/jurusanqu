...
<body>
    <div class="page-orange">
        ...
        <div class="d-flex justify-content-center justify-content-md-end align-items-center flex-column-reverse flex-md-column content-hero">
            <a class="btn-start btn" href="/form">MULAI TES</a>
